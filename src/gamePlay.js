...
GamePlayManager = {
    ...
    create: function() {
        ...
        this.fishes = game.add.sprite(100,250, 'fishes');
        ...
        this.timeGameOver = game.time.events.loop(Phaser.Timer.SECOND, function(){
            if(this.flagFirstMouseDown){
                this.totalTime--;
                this.timerText.text = this.totalTime+'';
                if(this.totalTime<=0){
                    game.time.events.remove(this.timeGameOver);
                    this.endGame = true;
    ...
    isOverlapingOtherDiamond: function(index, rect2){
        for(var i=0; i<index; i++){
            var react1 = this.getBoundsDiamond(this.diamonds[i]);
            if(this.isRectanglesOverlapping(react1, rect2)){
                return true;
            }
        }
    },
...
var game = new Phaser.Game(1136, 620, Phaser.AUTO);
